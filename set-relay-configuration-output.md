...
* Type: an array of merged types ([Details](set-relay-configuration-output-properties-networks-items.md))
...
an array of merged types ([Details](set-relay-configuration-output-properties-networks-items.md))
