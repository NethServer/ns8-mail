...
* [Domains with addaliases flag](./list-addresses-output-properties-domains-with-addaliases-flag.md) – `http://schema.nethserver.org/mail/list-addresses-output.json#/properties/addalias_domains`
