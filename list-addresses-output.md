...
| [addalias\_domains](#addalias_domains) | `array` | Required | cannot be null | [list-addresses output](list-addresses-output-properties-domains-with-addaliases-flag.md "http://schema.nethserver.org/mail/list-addresses-output.json#/properties/addalias_domains") |
...
* Type: `string[]` ([Domain name](list-addresses-output-properties-domains-with-addaliases-flag-domain-name.md))

* cannot be null

* defined in: [list-addresses output](list-addresses-output-properties-domains-with-addaliases-flag.md "http://schema.nethserver.org/mail/list-addresses-output.json#/properties/addalias_domains")

### addalias\_domains Type

`string[]` ([Domain name](list-addresses-output-properties-domains-with-addaliases-flag-domain-name.md))
