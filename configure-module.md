...
| :-------------------------------------- | :-------- | :------- | :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [mailbox\_quota\_mb](#mailbox_quota_mb) | `integer` | Optional | cannot be null | [configure-module input](configure-module-properties-user-mailbox-quota.md "http://schema.nethserver.org/mail/configure-module.json#/properties/mailbox_quota_mb") |
...
Default user mailbox quota expressed in MB (megabytes). Set to 0 to disable quota completely.
