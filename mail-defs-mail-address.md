...
* all of
  ...
  * [Address derived from users' LDAP mail attribute](mail-defs-mail-address-oneof-4-allof-address-derived-from-users-ldap-mail-attribute.md "check type definition")
