...
| [addaliases](#addaliases)   | `boolean`     | Optional | cannot be null | [Common schema definitions](mail-defs-mail-domain-properties-addaliases-flag.md "http://schema.nethserver.org/mail.json#/$defs/mail-domain/properties/addaliases")     |
...
Accept the LDAP mail attribute of a user as an additional valid mail address

`addaliases`

* is optional

* Type: `boolean` ([Addaliases flag](mail-defs-mail-domain-properties-addaliases-flag.md))

* cannot be null

* defined in: [Common schema definitions](mail-defs-mail-domain-properties-addaliases-flag.md "http://schema.nethserver.org/mail.json#/$defs/mail-domain/properties/addaliases")

#### addaliases Type

`boolean` ([Addaliases flag](mail-defs-mail-domain-properties-addaliases-flag.md))
